...
#pragma warning restore 0067
		...
		public void SetfieldSByteDirty()
		{
			_dirtyFields[0] |= 0x2;
			hasDirtyFields = true;
		}

		private void RunChange_fieldSByte(ulong timestep)
		{
			if (fieldSByteChanged != null) fieldSByteChanged(_fieldSByte, timestep);
			if (fieldAltered != null) fieldAltered("fieldByte", _fieldSByte, timestep);
		}
		...
		public void SnapInterpolations()
		{
			...
			fieldSByteInterpolation.current = fieldSByteInterpolation.target;
		...
		{
			ObjectMapper.Instance.MapBytes(data, _fieldByte);
			ObjectMapper.Instance.MapBytes(data, _fieldSByte);
			ObjectMapper.Instance.MapBytes(data, _fieldChar);
			ObjectMapper.Instance.MapBytes(data, _fieldShort);
			ObjectMapper.Instance.MapBytes(data, _fieldUShort);
			ObjectMapper.Instance.MapBytes(data, _fieldBool);
			ObjectMapper.Instance.MapBytes(data, _fieldInt);
			ObjectMapper.Instance.MapBytes(data, _fieldUInt);
			ObjectMapper.Instance.MapBytes(data, _fieldFloat);
			ObjectMapper.Instance.MapBytes(data, _fieldFloatInterpolate);
			ObjectMapper.Instance.MapBytes(data, _fieldLong);
			ObjectMapper.Instance.MapBytes(data, _fieldULong);
			ObjectMapper.Instance.MapBytes(data, _fieldDouble);
		...
		protected override BMSByte SerializeDirtyFields()
		{
			...
			if ((0x1 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldByte);
			if ((0x2 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldSByte);
			if ((0x4 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldChar);
			if ((0x8 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldShort);
			if ((0x10 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldUShort);
			if ((0x20 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldBool);
			if ((0x40 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldInt);
			if ((0x80 & _dirtyFields[0]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldUInt);
			if ((0x1 & _dirtyFields[1]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldFloat);
			if ((0x2 & _dirtyFields[1]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldFloatInterpolate);
			if ((0x4 & _dirtyFields[1]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldLong);
			if ((0x8 & _dirtyFields[1]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldULong);
			if ((0x10 & _dirtyFields[1]) != 0)
				ObjectMapper.Instance.MapBytes(dirtyFieldsData, _fieldDouble);
		...
		protected override void ReadDirtyFields(BMSByte data, ulong timestep)
		{
			...
			if ((0x1 & readDirtyFlags[0]) != 0)
			{
				...
				{
					fieldByteInterpolation.target = ObjectMapper.Instance.Map<byte>(data);
					fieldByteInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldByte = ObjectMapper.Instance.Map<byte>(data);
					RunChange_fieldByte(timestep);
				}
			}
			if ((0x2 & readDirtyFlags[0]) != 0)
			{
				if (fieldSByteInterpolation.Enabled)
				{
					fieldSByteInterpolation.target = ObjectMapper.Instance.Map<sbyte>(data);
					fieldSByteInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldSByte = ObjectMapper.Instance.Map<sbyte>(data);
					RunChange_fieldSByte(timestep);
				}
			}
			if ((0x4 & readDirtyFlags[0]) != 0)
			{
				...
				{
					fieldCharInterpolation.target = ObjectMapper.Instance.Map<char>(data);
					fieldCharInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldChar = ObjectMapper.Instance.Map<char>(data);
					RunChange_fieldChar(timestep);
				}
			}
			if ((0x8 & readDirtyFlags[0]) != 0)
			{
				...
				{
					fieldShortInterpolation.target = ObjectMapper.Instance.Map<short>(data);
					fieldShortInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldShort = ObjectMapper.Instance.Map<short>(data);
					RunChange_fieldShort(timestep);
				}
			}
			if ((0x10 & readDirtyFlags[0]) != 0)
			{
				...
				{
					fieldUShortInterpolation.target = ObjectMapper.Instance.Map<ushort>(data);
					fieldUShortInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldUShort = ObjectMapper.Instance.Map<ushort>(data);
					RunChange_fieldUShort(timestep);
				}
			}
			if ((0x20 & readDirtyFlags[0]) != 0)
			{
				...
				{
					fieldBoolInterpolation.target = ObjectMapper.Instance.Map<bool>(data);
					fieldBoolInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldBool = ObjectMapper.Instance.Map<bool>(data);
					RunChange_fieldBool(timestep);
				}
			}
			if ((0x40 & readDirtyFlags[0]) != 0)
			{
				...
				{
					fieldIntInterpolation.target = ObjectMapper.Instance.Map<int>(data);
					fieldIntInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldInt = ObjectMapper.Instance.Map<int>(data);
					RunChange_fieldInt(timestep);
				}
			}
			if ((0x80 & readDirtyFlags[0]) != 0)
			{
				...
				{
					fieldUIntInterpolation.target = ObjectMapper.Instance.Map<uint>(data);
					fieldUIntInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldUInt = ObjectMapper.Instance.Map<uint>(data);
					RunChange_fieldUInt(timestep);
				}
			}
			if ((0x1 & readDirtyFlags[1]) != 0)
			{
				...
				{
					fieldFloatInterpolation.target = ObjectMapper.Instance.Map<float>(data);
					fieldFloatInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldFloat = ObjectMapper.Instance.Map<float>(data);
					RunChange_fieldFloat(timestep);
				}
			}
			if ((0x2 & readDirtyFlags[1]) != 0)
			{
				...
				{
					fieldFloatInterpolateInterpolation.target = ObjectMapper.Instance.Map<float>(data);
					fieldFloatInterpolateInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldFloatInterpolate = ObjectMapper.Instance.Map<float>(data);
					RunChange_fieldFloatInterpolate(timestep);
				}
			}
			if ((0x4 & readDirtyFlags[1]) != 0)
			{
				...
				{
					fieldLongInterpolation.target = ObjectMapper.Instance.Map<long>(data);
					fieldLongInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldLong = ObjectMapper.Instance.Map<long>(data);
					RunChange_fieldLong(timestep);
				}
			}
			if ((0x8 & readDirtyFlags[1]) != 0)
			{
				...
				{
					fieldULongInterpolation.target = ObjectMapper.Instance.Map<ulong>(data);
					fieldULongInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldULong = ObjectMapper.Instance.Map<ulong>(data);
					RunChange_fieldULong(timestep);
				}
			}
			if ((0x10 & readDirtyFlags[1]) != 0)
			{
				...
				{
					fieldDoubleInterpolation.target = ObjectMapper.Instance.Map<double>(data);
					fieldDoubleInterpolation.Timestep = timestep;
				}
				else
				{
					_fieldDouble = ObjectMapper.Instance.Map<double>(data);
					RunChange_fieldDouble(timestep);
				}
			}
		}
		...
		public override void InterpolateUpdate()
		{
			...
			if (fieldSByteInterpolation.Enabled && !fieldSByteInterpolation.current.Near(fieldSByteInterpolation.target, 0.0015f))
			{
				_fieldSByte = (sbyte)fieldSByteInterpolation.Interpolate();
				RunChange_fieldSByte(fieldSByteInterpolation.Timestep);
			}
