...
namespace BeardedManStudios.Forge.Networking
{
	...
	/// </summary>
	public class ETCPServer : EBaseTCP, IServer
	{
		...
		{
			if (Disposed)
				throw new ObjectDisposedException("ETCPServer", "This object has been disposed and can not be used to connect, please use a new ETCPServer");
